...
import poster from "@/assets/punjabi-opener-poster.jpg";
...
export function InvitationOpener() {
  ...
  return (
    <div
      ...
      role="dialog"
      aria-label="Open Jitesh and Ankita's wedding invitation"
    >
      <video
        ref={videoRef}
      ...
      {!started && (
        ...
        >
          <span className="script text-xl text-[#f4d8a1]">Jitesh & Ankita</span>
